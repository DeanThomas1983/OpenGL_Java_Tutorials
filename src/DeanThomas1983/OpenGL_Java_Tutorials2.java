 ...
 * @author mbien
 */
public class OpenGL_Java_Tutorials2 extends JFrame {
    ...
    public static void main(String args[]) {
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                OpenGL_Java_Tutorials2 frame = new OpenGL_Java_Tutorials2();
